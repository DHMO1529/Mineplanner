...
#ifndef NDEBUG
 #define SQLITE3X_AUTOLINKLIB "sqlite3x_d.lib"
#else
 #define SQLITE3X_AUTOLINKLIB "sqlite3x.lib"
#endif
#pragma comment(lib,SQLITE3X_AUTOLINKLIB)
#pragma message("sqlite3x auto link to " SQLITE3X_AUTOLINKLIB)
